...
**Статус: завершен 29 июля 2026 года.** Definition of Done выполнен; дальнейшие изменения документации ведутся вместе с реализацией через требования и ADR.
...
**Статус: в работе с 29 июля 2026 года.** Запускаемый прототип и инструкция находятся в каталоге [`desktop`](../desktop/README.md).
...
5. Объявления, критичные квитанции, присутствие, DND, настройки уведомлений и раздел «Внимание».
...
- автоматическая проверка целостности и читаемости выполняется при создании каждой резервной копии;
...
- матрица совместимости Windows 10/11 с фактическими системными версиями WebView2 и Ubuntu 22.04 с WebKit2GTK ABI 4.1;
...
Включает эксплуатационные SLA/SLO, автоматическую проверку каждой резервной копии при создании, контролируемое управление релизами, мониторинг, проверенную политику хранения, security review и план обновления зависимостей Wails/WebView/Go/PostgreSQL.

Высокая доступность, дополнительные Linux-дистрибутивы, E2EE, треды, интеграции и другие клиенты рассматриваются только отдельными изменениями требований и ADR. Встроенная антивирусная проверка вложений исключена принятым решением OQ-016 и может появиться только после явной отмены этого решения.
...
| Desktop E2E | Ключевые сценарии на Windows и Ubuntu, клавиатурная навигация и проверки доступности WCAG 2.2 AA |
| Security | Сессии, IDOR, scope, утечки логов, права и аудит релизного SMB-каталога |
