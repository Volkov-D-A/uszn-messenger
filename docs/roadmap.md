...
Definition of Done: выполнены девять сценариев из [UX-спецификации](ux-spec.md#10-приемка-ux-прототипа), сборки запускаются на обеих ОС, критические UX-замечания занесены в требования.
...
5. Объявления, критичные квитанции, напоминания, присутствие и DND.
6. Retention, аудит, backup, launcher и автономная поставка.

Definition of Done:

- выполнены восемь критериев из [требований](product-requirements.md#5-критерии-приемки-целевого-mvp);
